    ...
    <>
      ...
      <div style={{
        ...
        <nav style={{ display:'flex', flexDirection:'column', padding:8, gap:2, flex:1, overflowY:'auto' }}>
          ...
          {/* OpenRouter Status */}
          <div style={{ margin:'10px 6px 0', background:'#080008', border:'1px solid #2a0018', borderRadius:12, padding:'12px 12px' }}>
            <div style={{ fontSize:10, color:'#550033', letterSpacing:1.5, textTransform:'uppercase', fontWeight:700, marginBottom:8 }}>⚡ AI Engine</div>
            <div style={{ fontSize:11, color:'#00aa66', background:'rgba(0,100,60,0.15)', border:'1px solid #003322', borderRadius:6, padding:'6px 8px', textAlign:'center' }}>
              ✅ OpenRouter Active
            </div>
            <div style={{ fontSize:10, color:'#444', textAlign:'center', marginTop:6 }}>
              Auto-fallback keys enabled
            </div>
          </div>
        </nav>
